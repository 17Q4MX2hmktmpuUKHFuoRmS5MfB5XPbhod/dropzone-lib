...
WebExplorer.prototype.save = function (attrs, privateKeyWif, cb) {
  ...
  this._createTransaction(privateKeyWif, attrs.tip, function (tx) { 
    console.log("uhuaouauo")
    console.log(this.prefix)

    // TODO: shewt, th prevTxId isn't available...
    var txoScpts = new TxEncoder(tx.inputs[0].prevTxId, attrs.data, {

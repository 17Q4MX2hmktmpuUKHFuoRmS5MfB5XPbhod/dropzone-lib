...
Session.prototype.getCommunicationInit = function (cb) {
  this._getChats(null, function (err, chats) {
    ...
    cb(null, chats.find(function (chat) { return chat.isInit() }))
  })
}
...
Session.prototype.getSymmKey = function (cb) {
  this.getNegotiation(function (err, commInit, commAuth) {
    ...
    var commPrivKey = [commInit, commAuth].find(function (msg) {
      return ((msg) && (msg.senderAddr === this.receiverAddr) &&
      (msg.receiverAddr === this.senderAddr))
    }, this)

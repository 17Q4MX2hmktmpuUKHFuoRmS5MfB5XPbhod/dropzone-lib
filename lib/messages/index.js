/**
 * @file Contains utilities for and inclusion of specific message objects
 * @module messages
 */
...
module.exports = {
  LATEST_VERSION_HEIGHT: message.ENCODING_VERSION_1_BLOCK,
  ...
  Item: item.Item,
  /**
   * Returns the unserialized and parsed Message object that corresponds to the
   * provided transaction object.
   *
   * NOTE: This is an internal function, though it may prove useful to others.
   *  note the esoteric format of the tx parameter.
   *
   * @function
   * @param {Driver} connection - blockchain connection
   * @param {Object} tx - Expected to be in the format of Message#toTransaction
   * @param {Buffer} tx.data - As returned by TxDecode#data
   * @param {String} tx.txid
   * @param {String} tx.receiverAddr
   * @param {String} tx.senderAddr
   * @param {Integer} tx.tip
   * @return {Messages}
   */

...
var Profile = function Profile (connection, addr) {
...
Profile.prototype._getMessages = function (options, cb) {
  if (!options) options = {}
  options.type = this.messageTypes
  this.connection.messagesByAddr(this.addr, options, cb)
}

Profile.prototype.getAttributes = function (options, cb) {
    ...
    async.whilst(
      ...
      function (next) {
        ...
        if (isFirstIteration && (profile.transferAddr !== null) &&
          ...
          new this.constructor(this.connection, profile.senderAddr).getAttributes(null,
